...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label.setText(_translate("SplashScreen", "Moil Apps"))
        ...
        self.label_credits.setText(_translate("SplashScreen", "<html><head/><body><p><span style=\" font-weight:600;\">Created</span>: Moil (c)-2023 </p></body></html>"))
