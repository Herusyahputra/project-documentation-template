...
class Controller(QtWidgets.QMainWindow):
    def __init__(self, ui, model, *args, **kwargs):
        ...
        self.connect_event()
        self.model.logger.info('MoilApp 4.1 Open Successfully')
    ...
    def init_config_github(self):
        self.repository_plugin_store_branch = "main"

    def add_full_screen_window_show_result(self):
        self.model.logger.info('set result image with full screen')
        ...
        # self.label_fff.setMaximumSize(QtCore.QSize(80, 30))
    ...
    def label_full_screen_double_click_event(self, event):
        self.model.logger.info('label_full_screen_double_click_event')
        self.show()
    ...
    def control_fov_full_screen(self):
        self.model.logger.info('control_fov_full_screen')
    ...
    def onclick_show_moilapp_plugin_store(self):
        self.model.logger.info('get_list_plugins')
    ...
    def get_list_plugins(self):
        ...
        try:
            url = f'https://api.github.com/repos/McutOIL/moilapp-plugins-store/contents?ref=' \
            ...
            self.model.logger.info('get_list_plugins connected!!!')

        except:
            QtWidgets.QMessageBox.information(None, "Information", "Connection Error or repository not found!!!")
            self.model.logger.warning('get_list_plugins Connection Error!!!')
            return
    ...
    def stylesheet_button_install_plugin(self, state="install"):
        self.model.logger.info('stylesheet_button_install_plugin')
        if state == "install":
            stylesheet = """
                    QPushButton {
                        color: rgb(25,25,25);
    ...
    def clicked_plugin_remove(self):
        ...
        """
        self.model.logger.info('clicked_plugin_remove')
        sender = self.sender()
        ...
        if reply == QtWidgets.QMessageBox.StandardButton.Yes:
            ...
            self.ui.add_plugins_button.show()
            self.get_list_plugins()
            self.model.logger.info('clicked_plugin_remove success')
        else:
            self.model.logger.info('clicked_plugin_remove no')

    def clicked_install_plugins(self):
        self.model.logger.info('clicked_install_plugins')
        sender = self.sender()
    ...
    def download_plugins_from_github(self, plugin):
        self.model.logger.info('download_plugins_from_github')
        path_file = os.path.abspath(".")
        try:
            repo_url = f'https://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@github.com/McutOIL/{plugin}'
            ...
            try:
                ...
                self.model.logger.warning('Have error in installation apps')
        except:
            self.pop_up_message_box("Have error in installation apps")
            return None
    ...
    def onclick_close_plugin_store(self):
        self.model.logger.info('onclick_close_plugin_store')
    ...
    def show_config_view_in_information(self, config):
        ...
        """
        self.model.logger.info('show_config_view_in_information')
    ...
    def reset_view_back_to_original(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('reset_view_back_to_original')
    ...
    def change_polygon_state(self):
        ...
        if self.ui.check_draw_poligon.isChecked():
            ...
            self.model.logger.info('change_polygon_state True')

        else:
            self.model_apps.set_draw_polygon = False
            self.model.logger.info('change_polygon_state False')
    ...
    def label_original_mouse_double_click_event(self, event):
        ...
        Returns:
            None.
        """
        self.model.logger.info('label_original_mouse_double_click_event')
    ...
    def label_recenter_mouse_press_event(self, event):
        self.model.logger.info('label_recenter_mouse_press_event')
    ...
    def label_original_mouse_press_event(self, event):
        ...
        Returns:
            None
        """
        self.model.logger.info('label_original_mouse_press_event')
        if event.buttons() == QtCore.Qt.MouseButton.LeftButton:
            if self.model_apps.state_rubberband:
                print("under developing")
            else:
    ...
    def label_result_mouse_double_click(self, event):
        ...
        Returns:
            None
        """
        self.model.logger.info('label_result_mouse_double_click')
        if self.model_apps.state_rubberband:
            self.model_apps.create_image_result()
            self.model_apps.state_rubberband = False
            self.model_apps.create_image_result()
    ...
    def label_result_mouse_press_event(self, event):
        ...
        """
        self.model.logger.info('label_result_mouse_press_event')
    ...
    def label_result_mouse_move_event(self, event):
        ...
        Returns:
            None.
        """
        self.model.logger.info('label_result_mouse_move_event')
        if event.buttons() == QtCore.Qt.MouseButton.LeftButton:
            if self.__image_result is not None:
    ...
    def label_result_mouse_release_event(self, event):
        ...
        Behavior:
            ...
            arguments.
        """
        self.model.logger.info('label_result_mouse_release_event')
        if event.button() == QtCore.Qt.MouseButton.LeftButton:
            if self.__image_result is not None:
    ...
    def label_original_mouse_release_event(self, event):
        ...
        Returns:
            None.
        """
        self.model.logger.info('label_original_mouse_release_event')
        if event.button() == QtCore.Qt.MouseButton.LeftButton:
            pass
        else:
    ...
    def menu_mouse_event(self, event, label):
        ...
        self.model.logger.info(f'menu_mouse_event in {label}')
        if self.model_apps.state_rubberband:
    ...
    def show_information_of_image(self, label):
        ...
        """
        self.model.logger.info(f'show_information_of_image {label}')
        if self.model_apps.state_rubberband:
    ...
    def save_image(self, image_result=True):
        ...
        """
        self.model.logger.info('save_image')
        if self.__image_result is not None:
            ...
            if self.__base_dir_save:
                ...
                self.model.logger.info('save_image success')
        else:
            self.model.logger.info('save_image failed')
    ...
    def onclick_record_video_button(self):
        ...
        Returns:
            None.
        """
        self.model.logger.info('onclick_record_video_button')
    ...
    def load_saved_image_list(self, load=False):
        ...
        Returns:
            None
        """
        self.model.logger.info('Load saved image from directory')
    ...
    def list_widget_saved_image_activated(self):
        ...
        Returns:
            None.
        """
        self.model.logger.info('list_widget_saved_image_activated')
    ...
    def lock_menu_state_view(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('lock_menu_state_view')
    ...
    def unlock_menu_state_view(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('unlock_menu_state_view')
        self.reset_style_button_menu()
    ...
    def reset_style_button_menu(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('reset_style_button_menu')
    ...
    def change_properties_panorama(self):
        ...
        Returns:
            None
            """
        self.model.logger.info('change_properties_panorama')
        if self.__image_result is not None:
            self.model_apps.state_rubberband = False
            if self.ui.radioButton_car.isChecked():
    ...
    def change_properties_crop_panorama(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('change_properties_crop_panorama')
        if self.__image_result is not None:
            self.model_apps.state_rubberband = False
            if self.ui.radioButton_car.isChecked():
                self.panorama_config.change_properties_panorama_car()
    ...
    def activate_change_optical_point(self):
        if self.ui.checkBox_reverse_view.isChecked():
            if self.model_apps.cap is None:
                if self.__image_result is not None:
                ...
                QtWidgets.QMessageBox.information(None, "Information",
                                                  "Recenter optical point not available yet for this source!")
    ...
    @classmethod
    def show_message(cls, title, message):
        ...
        msg.setStandardButtons(QtWidgets.QMessageBox.StandardButton.Ok)
        msg.show()
        QtCore.QTimer.singleShot(5000, lambda: msg.done(0))
    ...
    def onclick_btn_open_media(self):
        ...
        Returns:
            None.
        """
        self.model.logger.info('onclick_btn_open_media')
        cam_type, source_media, parameter_name = self.model.select_media_source()
        if source_media is not None:
            self.model_apps.set_media_source(cam_type, source_media, parameter_name)
            self.model_apps.create_maps_fov()
            if type(source_media) == int or source_media.endswith(('.mp4', '.MOV', '.avi', '.mjpg')):
                if self.model_apps.recenter_image_state:
                    self.model.logger.info('recenter image is active')
                    self.ui.widget_mode_view.hide()
                    self.ui.frame_recenter_image.hide()
                    self.ui.checkBox_reverse_view.setChecked(False)
                    self.model_apps.recenter_image_state = False
            ...
            if self.__image_result is not None:
                ...
                self.load_saved_image_list(load=True)
            self.model.logger.info('Media Open successfully')
        else:
            QtWidgets.QMessageBox.information(None, "Information!", "You not select any file !!")
            self.model.logger.info('Media is None')
    ...
    def control_video_controller(self, source_media_type):
        ...
        if source_media_type == "image":
            self.model.logger.info('control_video_controller hide')
            self.ui.frame_video_controller.hide()
        else:
            self.model.logger.info('control_video_controller show')
    ...
    def show_image_original(self, image):
        ...
        if self.full_screen_mode:
            self.model.logger.info('show_image_original full screen')
            ...
            self.model.logger.info('show_image_original not full screen')
    ...
    def show_image_result(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('show_image_result')
        if self.__image_result is not None:
            if self.full_screen_mode:
    ...
    def rotate_image(self, direction):
        ...
        """
        if self.__image_result is not None:
            self.model.logger.info('rotate_image')
            if direction == "left":
    ...
    def rotation_change_value(self):
        ...
        """
        if self.__image_result is not None:
            self.model.logger.info('rotation value has change')
    ...
    def onclick_btn_fisheye(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('onclick_btn_fisheye')
        ...
        if self.__image_result is not None:
            ...
            self.ui.widget_mode_view.hide()
            self.ui.frame_pointer_anypoint.hide()
            self.model.logger.info('onclick_btn_fisheye successfully')
        else:
            self.model.logger.info('onclick_btn_fisheye (image result was None)')
    ...
    def onclick_btn_anypoint(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('onclick_btn_anypoint')
        self.change_stylesheet_selected_menu()
        if self.__image_result is not None:
            ...
            self.ui.frame_pointer_anypoint.show()
            self.ui.widget_mode_view.setCurrentIndex(0)
            self.model.logger.info('onclick_btn_anypoint successfully')
        else:
            self.model.logger.info('onclick_btn_anypoint (image result was None)')
    ...
    def onclick_btn_panorama(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('onclick_btn_panorama')
        self.change_stylesheet_selected_menu()
        if self.__image_result is not None:
            ...
            self.ui.frame_pointer_anypoint.show()
            self.ui.widget_mode_view.setCurrentIndex(1)
            self.model.logger.info('onclick_btn_panorama successfully')
        else:
            self.model.logger.info('onclick_btn_panorama (image result was None)')
    ...
    def onclick_clear_user_interface(self):
        ...
        Returns:
            None.
        """
        self.model.logger.info('onclick_clear_user_interface')
        ...
        self.model.logger.info('onclick_clear_user_interface success')
    ...
    def onclick_play_pause_video_button(self):
        self.model.logger.info('onclick_play_pause_video_button')
        if self.model_apps.load_saved_image:
            self.reset_view_back_to_original()
        self.model_apps.play_pause_video()
        self.model.logger.info('onclick_play_pause_video_button success')
    ...
    def mouse_event_in_moil_logo(self, event):
        ...
        Returns:
            None
        """
        self.model.logger.info('mouse_event_in_moil_logo')
        if event.type() == QtCore.QEvent.Type.MouseButtonPress:
            if event.button() == QtCore.Qt.MouseButton.LeftButton:
                self.back_to_home()
                self.model.logger.info('mouse_event_in_moil_logo success')

    def onclick_help_button(self):
        self.model.logger.info('onclick_help_button')
    ...
    def back_to_home(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('back_to_home')
        self.ui.stackedWidget_2.setCurrentIndex(0)
        self.ui.widget_container_content.setCurrentIndex(0)
        ...
        self.model.logger.info('back_to_home success')
    ...
    def showing_git_repository_information(self, data=None):
        ...
        Returns:
            None
        """
        self.model.logger.info('showing_git_repository_information')
    ...
    def onclick_refresh_github_repository(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('onclick_refresh_github_repository')
        if self.__data_github["token"] is None:
    ...
    def check_for_update(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('check_for_update of repository')
        if not call(["git", "branch"], stderr=STDOUT, stdout=open(os.devnull, 'w')) != 0:
            if self.__data_github["token"] is None:
                if self.show_update_dialog(
                        "No token found, input your token?") == QtWidgets.QMessageBox.StandardButton.Yes:
    ...
    def check_for_new_update(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('check_for_new_update')
        current_hash = self.model_apps.repo_github.head.object.hexsha
        ...
        if latest_hash != current_hash:
            ...
            self.model.logger.info('The software is already up to date')
    ...
    def show_update_successful_message(self, message):
        ...
        Raises:
            None
        """
        self.model.logger.info('update software successful')
        msg = QtWidgets.QMessageBox()
        msg.setIcon(QtWidgets.QMessageBox.Icon.Information)
        msg.setWindowTitle("Information!!")
    ...
    def onclick_change_theme_apps(self):
        ...
        Returns:
            None
        """
        self.model.logger.info(f'set theme of MoilApp to {self.model.theme}')
        icon = QtGui.QIcon()
    ...
    def change_stylesheet_selected_menu(self):
        ...
        Returns:
            None
        """
        self.model.logger.info('change_stylesheet_selected_menu')
        if self.__image_result is not None:
            btn = self.sender()
