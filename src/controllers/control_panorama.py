...
class PanoramaConfig(object):
    ...
    def block_signal_pano_tube(self):
        ...
        - self.ui.spinBox_pano_tube_alpha_min
        - self.ui.spinBox_pano_tube_alpha_max
    ...
    def block_signal_pano_car(self):
        ...
        self._block_signal(
            [
                self.ui.spinBox_pano_car_alpha,
                self.ui.spinBox_pano_car_beta,
    ...
    def unblock_signal_pano_car(self):
        ...
        This function unblocks signals for the following widgets: spinBox_pano_car_alpha,
        spinBox_pano_car_beta, doubleSpinBox_pano_car_crop_left, doubleSpinBox_pano_car_crop_right,
    ...
    def showing_config_panorama_car(self):
        ...
        self.ui.spinBox_pano_car_alpha.setValue(int(self.__panorama_config["Pano_car"]["alpha"]))
        self.ui.spinBox_pano_car_beta.setValue(int(self.__panorama_config["Pano_car"]["beta"]))
    ...
    def change_properties_panorama_tube(self):
        ...
        Returns:
            None.
        """
        alpha_min = self.ui.spinBox_pano_tube_alpha_min.value()
        alpha_max = self.ui.spinBox_pano_tube_alpha_max.value()
