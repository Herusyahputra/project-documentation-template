    ...
    def __init_config_file(self):
        ...
        if not os.path.exists(self.__cached_file):
            config = {
                ...
                "Pano_tube": {
                    "alpha_min": round(self.ui.spinBox_pano_tube_alpha_min.value(), 3),
                    "alpha_max": round(self.ui.spinBox_pano_tube_alpha_max.value(), 3),
                ...
                "Pano_car": {
                    "coord": [None, None],
                    "alpha": round(self.ui.spinBox_pano_car_alpha.value(), 3),
                    "beta": round(self.ui.spinBox_pano_car_beta.value(), 3),
